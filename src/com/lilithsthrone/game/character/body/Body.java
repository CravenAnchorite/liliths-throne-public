...
public class Body implements XMLSaving {
	...
	public static class BodyBuilder implements Builder<Body> {
		...
		public BodyBuilder(Arm arm, Ass ass, Breast breast, Face face, Eye eye, Hair hair, Leg leg, Skin skin, BodyMaterial bodyMaterial, GenitalArrangement genitalArrangement, int height, int femininity, int bodySize, int muscle) {
			this.arm = arm;
			this.ass = ass;
			this.breast = breast;
			this.face = face;
