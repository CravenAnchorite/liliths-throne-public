...
import com.lilithsthrone.game.sex.sexActions.universal.consensual.ConChairKneelingPositions;
 ...
 * @author Innoxia
 */
public class SMChairKneeling extends SexManagerDefault {

	public SMChairKneeling() {
		super(// Self actions:
				...
				ConChairKneelingPositions.class,
